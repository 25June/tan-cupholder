...
export function HeroSection() {
  ...
  return (
    <div className="relative min-h-[90vh]">
      <div className="max-w-8xl w-full min-h-[90vh] md:min-h-full flex flex-col md:flex-row gap-4 md:gap-0 align-middle justify-center mx-auto pt-14 z-10 relative">
