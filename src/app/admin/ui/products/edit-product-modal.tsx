...
export default function EditProductModal({
  ...
  const autoDescription = () => {
    ...
    const productAppearance = (
      document.getElementById('product-appearance') as HTMLTextAreaElement
    )?.value;
    const productPromise = (
      document.getElementById('product-promise') as HTMLTextAreaElement
    )?.value;
  ...
  const handleGenerateDescription = async () => {
    ...
    formData.append(
      ...
      description ? autoDescription() : productType?.description || ''
    );
